...
/** Complete a production order atomically (FEFO consume + produce + genealogy) via the DB function. */
export async function completeProductionOrder(
  ...
  try {
    ...
    logger.info('production_order.completed', { id: productionOrderId, outputLot: data });
