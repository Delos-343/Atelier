# TechnicoFlor — Perfume ERP (Manufacturing Core) · v0.49.0
...
every release from v0.5 through the current **v0.49.0** — is kept in a dedicated document,
...
## Test coverage (294 tests, all passing)
