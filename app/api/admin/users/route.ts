...
export async function POST(request: Request) {
  // Account creation / invitation sends mail and mints auth users — throttle it.
  const limited = await enforceRateLimit(request, { name: 'account-create', limit: 10, windowMs: 60_000 });
